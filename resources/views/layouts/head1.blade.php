                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <div class="user-toggle">
                                ...
                                <div class="user-info d-none d-md-block">
                                    <div class="user-status text-uppercase">{{ (Auth::user()) ? Auth::user()->role_name : ''  }}</div>
                                    <div class="user-name dropdown-indicator text-uppercase">{{ (Auth::user())?Auth::user()->name:''  }}</div>
                                </div>
                            </div>
                        </a>
                        <div class="dropdown-menu dropdown-menu-md dropdown-menu-right dropdown-menu-s1">
                            <div class="dropdown-inner user-card-wrap bg-lighter d-none d-md-block">
                                <div class="user-card">
                                    ...
                                    <div class="user-info">
                                        <span class="lead-text text-uppercase">{{ Auth::user()->name  }}</span>
