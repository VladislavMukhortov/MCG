        ...
        <div class="nk-block-head-content">
            <nav>
                <ul class="breadcrumb breadcrumb-arrow">
                    ...
                    <li class="breadcrumb-item active fs-17px"><a href="{{ route('users.index') }}">Users</a></li>
        ...
        <div class="card-inner">
            <div class="card-title-group align-start gx-3 mb-3">
                ...
                <div class="card-tools">
                    <div class="dropdown">
                        @can('update', $reads)
                        <a href="#" class="btn btn-primary btn-dim d-none d-sm-inline-flex" data-toggle="modal" data-target="#modalTop">
...
<div class="col-xxl-6 mt-2">
    <div class="card card-bordered h-100">
        <div class="card-inner">
            ...
            <div class="card-inner">
                <div class="nk-block">
                    <form action="{{ route('users.password.set',$reads) }}" method="post" class="form-validate">
                        @method('PUT')
                        @csrf
                        <div class="row g-4">
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        ...
                                        <input id="password_confirmation" type="password" class="form-control @error('password_confirmation') is-invalid @enderror" name="password_confirmation" placeholder="******"  autocomplete="new-password" required>
    ...
    <div class="modal-dialog modal-dialog-top" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('users.update',$reads->id) }}" method="post" class="form-validate">
                    @method('PUT')
                    @csrf
                    <div class="row g-4">
                        <div class="col-lg-12">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <select class="form-select form-control form-control-lg" data-search="on" name="role_id" required>
                                        <option selected disabled>Add Roles</option>
                                        @foreach($roleslist as $id => $rolename)
                                        <option value="{{ $rolename->id }}" @if($reads->isA($rolename->name)) selected='selected' @endif>
