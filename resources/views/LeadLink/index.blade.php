...
@section('page-content')
    <form action="{{ route('lead-form.store') }}" id="form" method="POST" enctype="multipart/form-data">
        @csrf
        <main class="vv-main">
            <div class="vv-header">
                                ...
                                <div class="col-lg-12 mb-3 my-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input class="form-control" type="text" placeholder="First name" name="firstname" value="{{ $lead->name ?? '' }}">
                                            </div>
                                        </div>
                                ...
                                <div class="col-lg-12 mb-3 my-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input class="form-control" type="text"
                                                       placeholder="Lastname" value="{{ $lead->last_name ?? '' }}">
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-12 mb-3 my-3">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input class="form-control"  type="text"
                                                       placeholder="Email"  name="email" value="{{ $lead->email ?? '' }}">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input class="form-control" v-mask="'+1 (###) ###-##-##'"
                                                       :class="{ 'is-danger': failed }" type="text" placeholder="Phone" value="{{ $lead->phone?? '' }}"
                                                        name="phone">
                                            </div>
                                        </div>
                                ...
                                <div class="field">
                                    <validation-provider rules="required|min:5|max:60" immediate
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input class="form-control" type="text"
                                                       placeholder="Street 1" name="street1" value="{{ $leadAddress->address }}">
                                            </div>
                                        </div>
                                    </validation-provider>
                                </div>
                                <div class="field">
                                    <validation-provider rules="min:5|max:60" v-slot="{ errors, failed }">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input class="form-control" type="text"
                                                       placeholder="Street 2" name="street2" value="{{ $leadAddress->street }}">
                                            </div>
                                        </div>
                                    </validation-provider>
                                </div>
                                <div class="field">
                                    <validation-provider rules="required|min:5|max:45" immediate
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input class="form-control"  type="text" placeholder="City" name="city" value="{{ $leadAddress->city }}">
                                            </div>
                                        </div>
                                    </validation-provider>
                                </div>
                                <div class="field">
                                    <validation-provider rules="required|max:5" immediate v-slot="{ errors, failed }">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input class="form-control" type="text"
                                                       placeholder="State"  name="state" value="{{ $leadAddress->state }}">
                                            </div>
                                        </div>
                                    </validation-provider>
                                </div>
                                <div class="field">
                                    <validation-provider rules="required" immediate v-slot="{ errors, failed }">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input class="form-control" v-mask="'#####-####'" type="text" placeholder="Zip" name="zip" value="{{ $leadAddress->zip }}">
