    ...
    let rules = [
        ...
        },
        {
            ...
            'rules': [
                ...
                ($('#address').val().length >= 2 || $('#address').val().length == 0),
                ($('#address').val().length <= 60 || $('#address').val().length == 0),
            ],
            'messages': [
                'only A-z and 0-9',
                'Address is at least 2 characters',
        ...
        },
        {
            ...
            'rules': [
                ...
                ($('#street-address').val().length >= 2 || $('#street-address').val().length == 0),
        ...
        },
        {
            ...
            'rules': [
                ...
                ($('#city').val().length >= 2 || $('#city').val().length == 0),
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                if(!data.email){
                    ...
                    $("#email").parent().append("<span class='help-block error' id='id-err'> email " + data.email +  " already exists </span>");
                }
            }
        });
    }
